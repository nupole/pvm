...
class PcieTransactionLayerPacketHeaderCommonDecoderModel(pyuvm.uvm_subscriber):
    def build_phase(self):
        self._decoder = PcieTransactionLayerPacketHeaderCommonDecoder(int(cocotb.top.UPSTREAM_WORD_WIDTH.value))
