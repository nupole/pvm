...
class PcieTransactionLayerPacketHeaderCommonAttrDecoderModel(pyuvm.uvm_subscriber):
    def build_phase(self):
        self._decoder = PcieTransactionLayerPacketHeaderCommonAttrDecoder(int(cocotb.top.UPSTREAM_WORD_WIDTH.value))
